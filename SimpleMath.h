...
namespace DirectX
{
		...
		struct Matrix : public XMFLOAT4X4
		{
			...
			// Static functions
			static Matrix Compose(const Vector3& translation, const Quaternion& rotation, const Vector3& scale);
...
namespace std
{
	...
	template<> struct less<DirectX::Rectangle>
	{
		bool operator()(const DirectX::Rectangle& r1, const DirectX::Rectangle& r2) const
		{
			return ((r1.x < r2.x)
				|| ((r1.x == r2.x) && (r1.y < r2.y))
	...
	template<> struct less<DirectX::Vector2>
	{
		bool operator()(const DirectX::Vector2& V1, const DirectX::Vector2& V2) const
		{
			return ((V1.x < V2.x) || ((V1.x == V2.x) && (V1.y < V2.y)));
		}
	};

	template<> struct less<DirectX::Vector3>
	{
		bool operator()(const DirectX::Vector3& V1, const DirectX::Vector3& V2) const
		{
			return ((V1.x < V2.x)
				|| ((V1.x == V2.x) && (V1.y < V2.y))
	...
	template<> struct less<DirectX::Vector4>
	{
		bool operator()(const DirectX::Vector4& V1, const DirectX::Vector4& V2) const
		{
			return ((V1.x < V2.x)
				|| ((V1.x == V2.x) && (V1.y < V2.y))
				|| ((V1.x == V2.x) && (V1.y == V2.y) && (V1.z < V2.z))
	...
	template<> struct less<DirectX::Matrix>
	{
		bool operator()(const DirectX::Matrix& M1, const DirectX::Matrix& M2) const
		{
	...
	template<> struct less<DirectX::Plane>
	{
		bool operator()(const DirectX::Plane& P1, const DirectX::Plane& P2) const
		{
			return ((P1.x < P2.x)
				|| ((P1.x == P2.x) && (P1.y < P2.y))
	...
	template<> struct less<DirectX::Quaternion>
	{
		bool operator()(const DirectX::Quaternion& Q1, const DirectX::Quaternion& Q2) const
		{
			return ((Q1.x < Q2.x)
				|| ((Q1.x == Q2.x) && (Q1.y < Q2.y))
	...
	template<> struct less<DirectX::Color>
	{
		bool operator()(const DirectX::Color& C1, const DirectX::Color& C2) const
		{
			return ((C1.x < C2.x)
				|| ((C1.x == C2.x) && (C1.y < C2.y))
	...
	template<> struct less<DirectX::Ray>
	{
		bool operator()(const DirectX::Ray& R1, const DirectX::Ray& R2) const
		{
	...
	template<> struct less<DirectX::Viewport>
	{
		bool operator()(const DirectX::Viewport& vp1, const DirectX::Viewport& vp2) const
		{
